...
('首页', 0, '/dashboard', 'Dashboard', 'A', 1, 1),
('权限管理', 0, '/system', 'system/Index', 'A', 2, 1),
('用户管理', 3, '/system/user', 'system/User', 'A', 1, 1),
('用户列表', 4, '/system/user', 'system/UserList', 'A', 1, 1),
('用户详情', 4, '/system/user/detail', 'system/UserDetail', 'A', 2, 1),
('角色管理', 3, '/system/role', 'system/Role', 'A', 2, 1),
('角色列表', 6, '/system/role', 'system/RoleList', 'A', 1, 1),
('角色权限', 6, '/system/role/permission', 'system/RolePermission', 'A', 2, 1),
('系统管理', 0, '/module', 'module/Index', 'A', 3, 1),
('菜单管理', 9, '/module/menu', 'module/Menu', 'A', 1, 1),
('菜单列表', 10, '/module/menu', 'module/MenuList', 'A', 1, 1),
('菜单详情', 10, '/module/menu/detail', 'module/MenuDetail', 'A', 2, 1),
('接口管理', 9, '/module/api', 'module/Api', 'A', 4, 1),
('接口列表', 13, '/module/api', 'module/ApiList', 'A', 1, 1),
('流程设计', 0, '/flow/definition/list', 'flow/definition/FlowDefinitionList', 'A', 4, 1),
('待办任务', 0, '/my/pending', 'flow/my/MyPending', 'A', 5, 1),
('我的流转', 0, '/my/initiated', 'flow/my/MyInitiated', 'A', 6, 1),
('我的审批', 0, '/my/approval', 'flow/my/MyApproval', 'A', 7, 1);

-- 插入菜单数据 - 模块B（支持三级和四级菜单）
INSERT INTO sys_menu (menu_name, parent_id, path, component, module_code, sort, status) VALUES
('首页', 0, '/dashboard', 'Dashboard', 'B', 1, 1),
('权限管理', 0, '/system', 'system/Index', 'B', 2, 1),
('用户管理', 20, '/system/user', 'system/User', 'B', 1, 1),
('用户列表', 21, '/system/user', 'system/UserList', 'B', 1, 1),
('用户详情', 21, '/system/user/detail', 'system/UserDetail', 'B', 2, 1),
('角色管理', 20, '/system/role', 'system/Role', 'B', 2, 1),
('角色列表', 24, '/system/role', 'system/RoleList', 'B', 1, 1),
('角色权限', 24, '/system/role/permission', 'system/RolePermission', 'B', 2, 1),
('系统管理', 0, '/module', 'module/Index', 'B', 3, 1),
('菜单管理', 27, '/module/menu', 'module/Menu', 'B', 1, 1),
('菜单列表', 28, '/module/menu', 'module/MenuList', 'B', 1, 1),
('菜单详情', 28, '/module/menu/detail', 'module/MenuDetail', 'B', 2, 1),
('接口管理', 27, '/module/api', 'module/Api', 'B', 4, 1),
('接口列表', 31, '/module/api', 'module/ApiList', 'B', 1, 1),
('流程设计', 0, '/flow/definition/list', 'flow/definition/FlowDefinitionList', 'B', 4, 1),
('待办任务', 0, '/my/pending', 'flow/my/MyPending', 'B', 5, 1),
('我的流转', 0, '/my/initiated', 'flow/my/MyInitiated', 'B', 6, 1),
('我的审批', 0, '/my/approval', 'flow/my/MyApproval', 'B', 7, 1);

-- 插入菜单数据 - 模块C（支持三级和四级菜单）
INSERT INTO sys_menu (menu_name, parent_id, path, component, module_code, sort, status) VALUES
('首页', 0, '/dashboard', 'Dashboard', 'C', 1, 1),
('权限管理', 0, '/system', 'system/Index', 'C', 2, 1),
('用户管理', 38, '/system/user', 'system/User', 'C', 1, 1),
('用户列表', 39, '/system/user', 'system/UserList', 'C', 1, 1),
('用户详情', 39, '/system/user/detail', 'system/UserDetail', 'C', 2, 1),
('角色管理', 38, '/system/role', 'system/Role', 'C', 2, 1),
('角色列表', 42, '/system/role', 'system/RoleList', 'C', 1, 1),
('角色权限', 42, '/system/role/permission', 'system/RolePermission', 'C', 2, 1),
('系统管理', 0, '/module', 'module/Index', 'C', 3, 1),
('菜单管理', 45, '/module/menu', 'module/Menu', 'C', 1, 1),
('菜单列表', 46, '/module/menu', 'module/MenuList', 'C', 1, 1),
('菜单详情', 46, '/module/menu/detail', 'module/MenuDetail', 'C', 2, 1),
('接口管理', 45, '/module/api', 'module/Api', 'C', 4, 1),
('接口列表', 49, '/module/api', 'module/ApiList', 'C', 1, 1),
('流程设计', 0, '/flow/definition/list', 'flow/definition/FlowDefinitionList', 'C', 4, 1),
('待办任务', 0, '/my/pending', 'flow/my/MyPending', 'C', 5, 1),
('我的流转', 0, '/my/initiated', 'flow/my/MyInitiated', 'C', 6, 1),
('我的审批', 0, '/my/approval', 'flow/my/MyApproval', 'C', 7, 1);

-- 插入公共菜单
INSERT INTO sys_menu (menu_name, parent_id, path, component, module_code, sort, status) VALUES
('系统管理', 0, '/system', 'system/Index', NULL, 100, 1),
('用户管理', 54, '/system/user', 'system/User', NULL, 1, 1),
('角色管理', 54, '/system/role', 'system/Role', NULL, 2, 1),
